...
//
// Anything wrapped in class="copyable" here becomes click-to-copy on the
// dashboard: components/EditableCopy.js injects a "copy" chip after it, and
// clicking either the sentence or the chip copies it and shows a green tick.
// The wording is part of this editable block, so the admin can reword it
// freely — whatever they write is what gets copied.
export const DEFAULT_DASHBOARD_HTML = `<p><span class="copyable">Congratulations for your earnings.</span></p>
<div class="notice">Your coins are verified from your play history and the friends you brought in. When you're ready to be paid, add your payout details above and our team will send your reward.</div>

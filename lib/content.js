...
// The editable MESSAGE area on each logged-in player's dashboard. This sits
// between their (protected) coin balance and their (protected) payout form —
// the admin can freely edit this text, but never a user's coins or payout details.
export const DEFAULT_DASHBOARD_HTML = `<div class="notice">Your coins are verified from your play history and the friends you brought in. When you're ready to be paid, add your payout details below and our team will send your reward.</div>
